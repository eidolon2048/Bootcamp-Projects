...
The goal of this project is to detect faces and classify facial emotions from images and video.

The final application predicts five emotions:
...
6. Deploy the final workflow as a Streamlit app.
...
4. Streamlit App/
  Streamlit app for image upload, video upload, and live camera emotion recognition.
